...
<?php
$this->load->view('user/laksana/_partials/header'); ?>


<body id="page-top">
    <?php $this->load->view('user/laksana/_partials/sidebar_usr'); ?>
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <!-- Topbar -->
            <?php $this->load->view('user/laksana/_partials/topbar'); ?>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="box-body">
                                                            ...
                                                            <?php echo form_open_multipart('user/dashboard_usr/update_profilLaksana/' . $user['id_usr']); ?>
                                        ...
                                        <div class="modal fade" id="ubah-password">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="<?php echo site_url('user/dashboard_usr/ubah_passwordLaksana'); ?>"
                                                            method="post">
                                                            <div class="form-group">
            ...
            <!-- End of Main Content -->
            <?php $this->load->view('user/laksana/_partials/footer'); ?>