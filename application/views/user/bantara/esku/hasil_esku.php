                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="tombol-edit btn btn-primary btn-sm" data-toggle="modal"
                                                data-target="#detail<?php echo $data->id_tempuh ?>">Tempuh Ulang</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                ...
                                <div class="modal-body">
                                    <div class="box-body">
                                        ...
                                        <form class="user" method="post"
                                            action="<?= site_url('user/esku_laksana/tempuh_ulang/' . $data->id_siswa) ?>"
                                            ...
                                            <input name="tingkat_sku" type="text" class="form-control" value="laksana"
                                                hidden>
