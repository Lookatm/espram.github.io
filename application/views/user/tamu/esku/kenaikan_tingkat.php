                        ...
                        <div class="card shadow h-100 py-2 alert-ivory">
                            <div class="card-body">
                                ...
                                <div class="modal-footer">
                                    <a href="<?= site_url('user/esku_bantara/do_unduh'); ?>"
                    ...
                    <div class="col-xl-6 col-md-6 mb-4">
                        <div class="card shadow h-100 py-2 alert-ivory">
                            <div class="card-body">
                                ...
                                <?php echo form_open_multipart('user/esku_bantara/unggah_file/' . $user['id_usr']); ?>
                                ...
                                <input name="golongan_" type="text" class="form-control" value="bantara" hidden>
                                <br>
                                <div class="col-sm-9">
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                ...
                                <form class="user" method="post"
                                    action="<?= site_url('user/esku_bantara/edit_unggah/' . $data['id_siswa']) ?>"
