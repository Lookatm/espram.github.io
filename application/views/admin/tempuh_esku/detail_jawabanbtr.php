                            ...
                            <table class="table table-bordered text-ivory" id="table-id" style="font-size:13px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($data['hasil_'] == "lulus") {
                                                    echo 'Sudah Dinilai';
                                                } elseif ($data['hasil_'] == "tidak lulus") {
                                                    echo 'Sudah Dinilai';
                                                } else {
                                                    echo 'Belum Dinilai';
                                                } ?>
                                ...
                                <div class="modal-body">
                                    <div class="box-body">
                                        <form class="user" method="post"
                                            action="<?= site_url('admin/penilaian_sku/tambah_nilaibtr/' . $data['id_tempuh']) ?>"
                                            ...
                                            <div class=" form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input name="nilai2_" type="number" class="form-control"
                                            ...
                                            <div class=" form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input name="nilai_akhir" type="text" class="form-control"
                                                        value="<?php echo $data['nilai_akhir']; ?>">
                                                </div>
                                            </div>
